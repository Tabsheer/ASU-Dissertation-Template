...
\listadd{\titlelines}%
  {Second Line of the Title}            % If you want to
                                        ...
                                        %   second line
\newcommand*\Author{Tabsheer Ali Askari}          %<Enter your name; must match official transcript
...
\newcommand*\defdate{April 2024}        %<Give month (written out fully) and year of
                                        %   the oral defense
\listadd{\committeechair}{Hamid Marvi}   %<Enter committee chair name; use \listadd for
...
\newcommand*{\chairlabel}{Chair}        %<If you have co-chairs, replace this text with
                                        %   'Co-Chair'
\listadd{\committeemember}{Hyunglae Lee} %<Enter committee member names; use \listadd for
\listadd{\committeemember}{Zhe Xu} %   additional names
